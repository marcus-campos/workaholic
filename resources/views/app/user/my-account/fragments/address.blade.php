<div id="user-address">
    ...
    <div class="row" v-show="!isCreatingOrEditing">
        <div class="col-sm-12">
            <div class="card-box m-b-10">
                <div class="table-box opport-box">
                    <div class="row">
                        <div class="col-sm-10">
                            <p class="text-dark m-b-0"><b>Logradouro: </b> <span class="text-muted">  job.created_at | c-dmy  </span></p>
                            <p class="text-dark m-b-0"><b>Numero: </b> <span class="text-muted">  job.proposals_count  </span></p>
                            <p class="text-dark m-b-0"><b>Complemento: </b> <span class="text-muted"> job.job_category.name </span></p>
                            <p class="text-dark m-b-0"><b>Bairro:</b> <span class="text-muted">  job.city.name  </span></p>
                            <p class="text-dark m-b-0"><b>Cep:</b> <span class="text-muted">  job.neighborhood  </span></p>
                            <p class="text-dark m-b-0"><b>Cidade:</b> <span class="text-muted">  job.neighborhood  </span></p>
                        </div>
                        <div class="col-sm-2">
                            <a  class="job-action-btn" ><i class="md md-edit"></i></a>
                            <a href="#" class="job-action-btn" ><i class="md md-close"></i></a>
                        </div>
                    </div>
                </div>
            </div>
