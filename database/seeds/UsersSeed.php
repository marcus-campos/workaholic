...
class UsersSeed extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO users (id, name, email, password, photo, biography, cpf, cnpj, address, number, complement, neighborhood, phone, cep, city_id, score, role, remember_token, deleted_at, created_at, updated_at) VALUES (3, 'Admin', 'admin@orkaholic.com.br', '" . $adminPassword . "', null, null, '11947469690', null, 'Rua Idalina Damásia', 123, null, 'Jardim da Cidade', '31 993195689', '32604280', 1417, 0, 'admin', 'wMjcYpppczt7m4EV2Xy5iIY0qaZzeeWSTxNbilXIlOehgYuGSxsYr3cInAZW', null, '2018-03-28 22:14:56', '2018-03-28 22:14:56');");
    }
}
