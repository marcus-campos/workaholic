...
class UsersSeed extends Seeder
{
    ...
    public function run()
    {
        if (env('APP_ENV') != 'production') {
            ...
            DB::insert("INSERT INTO users (id, name, email, password, photo, biography, cpf, cnpj, phone, score, role, remember_token, deleted_at, created_at, updated_at) VALUES ('" . Str::orderedUuid() . "', 'Amanda Palmela', 'amandapalmela@gmail.com', '" . $password . "', null, null, '12345678912', null, '31 993195689', 0, 'user', 'wMjcYpppczt7m4EV2Xy5iIY0qaZzeeWSTxNbilXIlOehgYuGSxsYr3cInAZW', null, '2018-03-28 22:14:56', '2018-03-28 22:14:56');");
